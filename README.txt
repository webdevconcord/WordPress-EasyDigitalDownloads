...
=== ConcordPay Payment Gateway for Easy Digital Downloads ===
Contributors: Mustpay
Tags: merchant, online payment, payment gateway, acquiring, easy digital downloads, concordpay, concord, payment, commerce, visa, applepay, googlepay
...
Thanks to the plugin for WordPress Easy Digital Downloads, you can double the conversion on your site!
...
* One-click payment. Make your customer's future purchases easier. The ConcordPay system will remember the necessary data of buyers after the first payment and substitute them in the next.
...
1. Plugin settings.
2. Payment window in your account on the site.
...
Download ConcordPay payment acceptance plugin for Easy Digital Downloads from the WordPress add-ons directory.
Unpack this plugin into the /wp-content/plugins/ directory. After that activate it in the "Plugins" menu.
...
1. Go to "Downloads -> Settings -> Payments -> Gateways”.
2. Enable ConcordPay in "Payment Gateways", set ConcordPay as default gateway, save settings.
3. Go to "ConcordPay" tab. Enter the data you received from ConcordPay (can be found in your merchant's technical settings).
    You need to fill in two fields:
    * Merchant ID;
    * Secret key.
4. Set the language of the payment page and the status of the order at different stages of its existence.
5. Select ConcordPay payment page language.
6. Save the settings.
